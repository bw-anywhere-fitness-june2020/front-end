...
const Classes = () => {
    ...
    useEffect(() => {
        axiosWithAuth()
            .get("https://anywhere-back-end.herokuapp.com/api/class")
            .then((res) => {
                console.log(res);
            ...
            <div className="classes">
                {
                    classes.map((item) => {
                        return(
                        <Card className="class" body inverse style={{ backgroundColor: '#333', borderColor: '#333' }}>
                            ...
                            <p className="card-label">Number of registered attendees</p>
                            <p className="card-content">{item.current_number_of_registered_attendees}</p>
